...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__api_util_js__ = __webpack_require__(0);


//
__WEBPACK_IMPORTED_MODULE_0__api_util_js__["a" /* APIUtil */].fetchTweets().then( (result) => {
    console.log(result)
    ...
    __WEBPACK_IMPORTED_MODULE_0__api_util_js__["a" /* APIUtil */].fetchSentiments(tweetTexts[0]).then(
