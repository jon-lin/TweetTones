...
app.get('/jquery.popuptooltip.min.css', function (req, res) {
  res.sendFile(path.join(__dirname + '/javascripts/jquery.popuptooltip.min.css'));
});

app.get('/jquery.popuptooltip.min.js', function (req, res) {
  res.sendFile(path.join(__dirname + '/javascripts/jquery.popuptooltip.min.js'));
});
