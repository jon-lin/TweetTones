...
// app.get('/tweetTonesJS', function (req, res) {
//   res.sendFile(path.join(__dirname + '/../frontend/tweet_tones.js'));
//   res.sendFile(path.join(__dirname + '/../app/assets/javascripts/bundle.js'));
// });
