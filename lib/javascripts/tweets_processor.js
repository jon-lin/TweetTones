...
class TweetsProcessor {
  ...
  displaySentimentData() {
    ...
    //following line needed to remove redundant elements from slick slides,
    //which already have iframes b/c of how Chart.js works
    $('.barcharts-carousel-container').slick('slickFilter', 'canvas');
    // $('.tweets-carousel-container').slick('slickUnfilter');
  }
